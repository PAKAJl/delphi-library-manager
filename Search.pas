...
begin
  ...
  begin
    ...
    Form4.StringGrid1.Cells[0,j] :=  Form2.ADOQuery2.FieldByName('BookName').Value;
    Form4.StringGrid1.Cells[1,j] :=  Form2.ADOQuery2.FieldByName('Author').Value;
    Form4.StringGrid1.Cells[2,j] :=  Form2.ADOQuery2.FieldByName('Genre').Value;
    Form4.StringGrid1.Cells[3,j] :=  Form2.ADOQuery2.FieldByName('CountBooks').Value;
